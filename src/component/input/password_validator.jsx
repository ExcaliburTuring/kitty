...
require('./password_validator.less');
...
var PasswordValidator = React.createClass({
    ...
    render: function() {
        ...
        if (this.props.valid) {
            validatorTitle =
                <h4 className="validator_title valid"> {this.props.name} IS OK</h4>
        } else {
            validatorTitle =
                <h4 className="validator_title invalid"> {this.props.name} RULES </h4>
        }
