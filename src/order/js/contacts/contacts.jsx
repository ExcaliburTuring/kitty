...
var Contacts = React.createClass({
    ...
    render: function() {
        ...
        var names = contacts.map(function(contact) {
            ...
            return (
              <div className="names" key={contact.contactid}><input type="checkbox" value={contact.contactid} onChange={self.handleChange} checked={itemchecked}/>{contact.name}</div>
            );
        });

        const title = (
            <div className="panel-title">出行人信息
            <FormGroup inline>
                {names}
            </FormGroup>
