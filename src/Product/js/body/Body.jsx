		...
		return(
				<div>
	                ...
	                <div className="notice">
		                <div className="content">
		                	<div className="left">
		                		<h1><i className="fa fa-credit-card"/>{this.state.notice.visa}</h1>
		                		<p/>{this.state.notice.h1}<br/>{this.state.notice.h2}<br/>{this.state.notice.h3}<br/>{this.state.notice.h4}
		                		<p/>{this.state.notice.h5}<br/>{this.state.notice.h6}<br/>{this.state.notice.h7}<br/>{this.state.notice.h8}
		                	</div>
		                	<div className="right">
		                		<h1><i className="fa fa-plane"/>{this.state.notice.ticket}</h1>
		            ...
		            <div className="expense">
		                <div className="content">
		                	<div className="left">
		                		<h1><i className="fa fa-credit-card"/>{this.state.expense.visa}</h1>
		                	...
		                	<div className="right">
		                		<h1><i className="fa fa-plane"/>{this.state.expense.ticket}</h1>
